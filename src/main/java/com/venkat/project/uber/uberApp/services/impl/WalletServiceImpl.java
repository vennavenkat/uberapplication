...
import com.venkat.project.uber.uberApp.dto.WalletDto;
...
import com.venkat.project.uber.uberApp.repositories.WalletRepository;
...
//		wallet.getTransactions().add(walletTransaction);
	...
	public Wallet findByUser(User user) {
		return walletRepository.findByUser(user)
				.orElseThrow(() -> new ResourceNotFoundException("Wallet not foound for user with id:"+ user.getId()));
	}
